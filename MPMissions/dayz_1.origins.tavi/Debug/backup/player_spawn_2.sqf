private["_timeOut","_messTimer","_lastSave","_lastTemp","_debug","_isBandit","_isHero","_refObj","_size","_vel","_speed","_saveTime","_randomSpot","_tempPos","_distance","_mylastPos","_isSync","_veh","_humanity","_isBandit3","_model","_isBandit2","_lastUpdate","_hunger","_thirst","_listTalk","_rnd","_foodVal","_thirstVal","_result","_id","_lowBlood","_display","_control","_headShots","_kills","_killsH","_killsB","_zombies","_zombiesA","_groups","_dead","_loot","_wrecks","_lootL","_freeTarget","_startcombattimer","_combattimeout","_timeleft","_color","_pmon1","_combatdisplay","_combatcontrol","_myPos","_lastPos","_debugAlex", "_ctrlhumanKills", "_ctrlheroKills", "_ctrlbanditKills", "_ctrlzombieKills", "_playerKills", "_heroKills", "_banditKills", "_zombieKills"];
...
//Debug Info
	...
	<t size='1.15' font='Bitstream' color='#5882FA'>Origins Classic 1</t><br/><br/>				
	...
	(_killsH)
            ...
            hintSilent parseText format ["
	<t size='1.15' font='Bitstream' color='#5882FA'>Origins Classic 2</t><br/><br/>				
	...
	(_killsH)
          ...
          hintSilent parseText format ["
	<t size='1.15' font='Bitstream' color='#5882FA'>Origins Classic 3</t><br/><br/>				
	<t size='1.25'font='Bitstream'align='center'color='#2ECCFA'>Not in Combat</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Players Online: </t><t size='0.95 'font='Bitstream' align='right'>%10</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Murders: </t><t size='1.15' font='Bitstream' align='right'>%1</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Hero's Murdered: </t><t size='1.15' font='Bitstream' align='right'>%2</t><br/>
