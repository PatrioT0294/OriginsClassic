...
if (!isDedicated) then {
	...
	player_addWeaponToBack =    compile preprocessFileLineNumbers "z\addons\dayz_code\compile\player_addWeaponToBack.sqf";
 player_switchWeapon =    compile preprocessFileLineNumbers "z\addons\dayz_code\compile\player_switchWeapon.sqf";
	...
	//hot keys
	//player_hot_keys = compile preprocessFileLineNumbers "\z\addons\dayz_code\system\hot_keys.sqf";
	...
	*/
	...
	test_function = {
	 _display = findDisplay 46;
		_display displaySetEventHandler ["KeyDown", "_this call player_hot_keys"];
	};
	*/
