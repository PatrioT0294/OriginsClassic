...
_playerID =	getPlayerUIDOld _player;
diag_log format ["POLUCHEN PLAYER ID %1", _playerID];
...
diag_log format ["LOG_BB3 _playerID(%1),item(%2),%3,%4",_playerID,_item,_player,_bb_baseserver];
