private["_characterID","_playerObj","_playerID","_selectedRegion","_arr_spawnPos","_slevel","_bbase","_selectedRegionV","_selectedRegion1","_dummy","_worldspace","_state","_doLoop","_key","_primary","_medical","_stats","_humanity","_randomSpot","_position","_debug","_distance","_distSB","_hit","_fractures","_score","_selectedRegionRandom","_findSpot","_isNear","_clientID", "_test_bandit", "_test_banditt"];
...
diag_log format ["TEST DEBUG _stats AFTER 102 1=%1",_stats];
diag_log format ["TEST DEBUG _state AFTER 102 1=%1",_state];
diag_log format ["TEST DEBUG _humanity AFTER 102 1=%1",_humanity];
...
diag_log format ["TEST DEBUG _playerObj AFTER 102 1=%1",_playerObj];
...
_test_bandit = _playerObj getVariable["banditKills", 0];
_test_banditt = _playerObj getVariable["banditKills", 1];
diag_log format ["TEST DEBUG banditKills1 AFTER 102 1=%1",_test_bandit];
diag_log format ["TEST DEBUG banditKills2 AFTER 102 1=%1",_test_banditt];
