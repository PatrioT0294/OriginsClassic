...
diag_log format ["TEST DEBUG CHARACTER 1=%1",_character];
_resulttest = typeName _character;
diag_log format ["TEST DEBUG CHARACTER TYPE1=%1",_resulttest];
...
diag_log format ["TEST DEBUG CHARACTER=%1",_characterID];
...
diag_log format ["TEST DEBUG server_playerSync BANDIT KILLS =%1",_killsB];
diag_log format ["TEST DEBUG server_playerSync H KILLS =%1",_killsH];
